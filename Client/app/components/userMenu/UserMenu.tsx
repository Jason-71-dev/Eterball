...
import { useRouter } from 'next/navigation'; // â† AJOUTER CETTE LIGNE
...
const UserMenu: FC = () => {
  ...
  const router = useRouter(); // â† AJOUTER CETTE LIGNE
      ...
      {open && (
        <div role="menu" aria-label="menu utilisateur" className={styles.menu}>
          ...
          <div className={styles.content}>
            ...
            <button
              onClick={handleLogout} // â† MODIFIER CETTE LIGNE
